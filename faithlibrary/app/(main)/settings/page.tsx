    ...
    return (
        <div style={{ minHeight: '100vh', background: '#F7F4F2' }} className="grain">
            ...
            <div style={{ maxWidth: 760, margin: '0 auto', padding: '32px 24px 64px', display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{
                    ...
                    <div style={{ padding: '24px' }}>
                        ...
                        <a href="/forgot-password" className="settings-reset-link" style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <button className="danger-zone-button" style={{
                            display: 'inline-flex', alignItems: 'center', gap: 6,
            ...
            <style>{`
                ...
                .danger-zone-button:hover { background: #FEF2F2; border-color: #DC2626; }
            `}</style>
        </div>
    )
}